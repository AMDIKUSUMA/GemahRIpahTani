...
class Berhasil : ComponentActivity() {
...

    {
        ...
        Text(
            ...
            modifier = Modifier
                .width(252.dp)
                .height(50.dp)
                .padding(start = 37.dp, top = 500.dp, end = 123.dp, bottom = 300.dp)
        )
        Text(
            ...
            modifier = Modifier
                .width(339.dp)
                .height(30.dp)
                .padding(start = 37.dp, top = 530.dp, end = 46.dp, bottom = 267.dp)
        )
