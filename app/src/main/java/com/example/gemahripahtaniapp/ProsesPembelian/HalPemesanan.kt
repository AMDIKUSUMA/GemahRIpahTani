...
@Composable
fun HalScreen(navController: NavHostController) {
        ...
        Column (
            ...
            Column(
                ...
                Row(
                    ...
                    ClickableText(
                        text = AnnotatedString("Metode Pembayaran"),
                        onClick = {
                ...
                horizontalAlignment = Alignment.CenterHorizontally)
            {
                Button(
                    onClick = {
                        ...
                        navController.navigate("LoadScreen")
                    },
                    modifier = Modifier
                        .width(339.dp)
...
fun GreetingPrevi() {
    GemahRipahTaniApp ()
    val navController = rememberNavController()
    HalScreen(navController =  navController)
}
